...
require __DIR__ . '/../app/Auth/ApiTokenAuth.php';
require __DIR__ . '/../app/Audit/Audit.php';
require __DIR__ . '/../app/AI/CreditConsumer.php';
require __DIR__ . '/../app/AI/TokenScopeValidator.php';
...
require __DIR__ . '/../app/Controllers/Settings/ReportPreferencesController.php';
require __DIR__ . '/../app/Controllers/Settings/ApiTokensController.php';
require __DIR__ . '/../app/Controllers/Settings/CreditLimitsController.php';
...
require __DIR__ . '/../app/Controllers/AI/ConsumeController.php';
...
require __DIR__ . '/../app/Controllers/Admin/FinancialAnalyticsController.php';
require __DIR__ . '/../app/Controllers/UploadController.php';
require __DIR__ . '/../app/Controllers/WorkspaceAdmin/AnalyticsController.php';
