...
- Insert dummy users/app roles/app permissions skeleton data.

## Create/update
- /app/Database/DB.php
- /app/Database/Migrator.php
- /app/Database/Seeder.php
- /app/Database/Migrations/0001_initial.php (users, app_roles, app_permissions, workspace_permissions, pivot tables, audit_logs, uploads)
- /scripts/migrate.php
- /scripts/seed.php
